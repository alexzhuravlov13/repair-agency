    ...
    <div class="container pb-5">
                    ...
                    <sec:authorize access="hasRole('ROLE_MANAGER')">
                        <form:form action="/repairs/manager/list" method="post" modelAttribute="filterDto">
                            ...
                            <div class="col m-3" style="display:inline-block">
                                ...
                                <div class="row">
                                    <form:select path="masterId" class="form-select form-select-sm m-3"
                                                 id="selectMaster">
                                        <option value=""></option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <button onclick="location.href='/repairs/manager/list/clear'" type="button"
                                                class="btn btn-outline-danger m-3"><spring:message
                                                code="repairForm.clear"/>
                                        </button>
                                    </div>
        ...
        <table class="table table-striped table-light">
            ...
            <tr>
                <th scope="col">#</th>
                <th scope="col"><a
                        href="${basePath}/page/${currentPage}?sortField=creationDate&sortDir=${reverseSortDir}">
